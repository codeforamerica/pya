Rails.application.routes.draw do
  ...
  scope "(:locale)", locale: /#{I18n.available_locales.join("|")}/ do
    ...
    get "phone_number", to: "phone_number#edit", as: "edit_phone_number"
    patch "phone_number", to: "phone_number#update"
    get "contact_preference", to: "contact_preference#show"
    patch "contact_preference", to: "contact_preference#update"
    get "verification_code", to: "verification_code#edit", as: "edit_verification_code"
    patch "verification_code", to: "verification_code#update"
    get "identification_number", to: "identification_number#edit", as: "edit_identification_number"
    patch "identification_number", to: "identification_number#update"
    get "mailing_address_validation", to: "mailing_address_validation#edit", as: "edit_mailing_address_validation"
