...
RSpec.describe MailingAddressValidationForm do
  ...
  let(:tax_year) { "2112" }
  let(:form) { described_class.new({selected_address: selected_address}, addresses: addresses, current_address: current_address, tax_year: tax_year) }
